...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><h2>Sistema Compra - Venta</h2></a>
  </div>
  <!-- /.login-logo -->
            ...
            if(isset($_GET["m"])){
              switch($_GET["m"]){
                ...
                <div class="alert alert-danger alert-dismissible">
                       ...
                       <h4><i class="icon fa fa-ban"></i> El correo y/o contraseña es incorrecto o no tienes permiso!</h4>
              </div>
              <?php
              break;
              ...
              case "2";
                ...
                <?php
              break;
              }//fin de mi switch case
            }//FIN DE MI CONDICIONAL 
            ?>
          </div>
        </div>
      </div>
